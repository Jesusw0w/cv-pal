  ...
  template: `
    <aside class="sidebar" [class.open]="open()">
      ...
      <nav class="sidebar-nav">
        ...
        <a routerLink="/profile" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          <span>Career Profile</span>
        </a>
        <a routerLink="/goals" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>
          <span>Goals</span>
        </a>
        <a routerLink="/documents" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
          <span>Documents</span>
        </a>
        <a routerLink="/analysis" routerLinkActive="active" class="nav-item" (click)="close.emit()">
        ...
        <a routerLink="/job-search" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
          <span>Job Search</span>
        </a>
        <a routerLink="/applications" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
          <span>Applications</span>
        </a>
        <a routerLink="/linkedin" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-4 0v7h-4v-7a6 6 0 016-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
          <span>LinkedIn</span>
        </a>
        <a routerLink="/ai-tools" routerLinkActive="active" class="nav-item" (click)="close.emit()">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a4 4 0 014 4c0 1.95-1.4 3.57-3.25 3.93a1.5 1.5 0 00-1.5 1.5V13"/><circle cx="12" cy="17" r="1"/><path d="M4.93 4.93l1.41 1.41M17.66 4.93l-1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 19.07l-1.41-1.41"/></svg>
          <span>AI Tools</span>
        </a>

        <div class="nav-divider"></div>

        <a routerLink="/settings" routerLinkActive="active" class="nav-item" (click)="close.emit()">
