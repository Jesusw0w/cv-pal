  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { title: 'AI Tools' },
        loadComponent: () =>
          import('./pages/ai-tools/ai-tools.component').then((m) => m.AiToolsComponent),
      },
      {
        path: 'analysis',
        data: { title: 'CV Analysis' },
        loadComponent: () =>
      ...
      },
      {
        ...
        data: { title: 'LinkedIn' },
        loadComponent: () =>
          import('./pages/linkedin/linkedin.component').then((m) => m.LinkedInComponent),
      },
      {
        path: 'settings',
        data: { title: 'Settings' },
